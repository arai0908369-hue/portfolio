...
const mediaContent = {
  youtube: `
    ...
    <a class="modal-link" href="https://youtube.com" target="_blank">Å® YouTubeView Channel</a>
  `,
  tiktok: `
    <div class="modal-thumb tk">ÅÙ</div>
    <h3>TikTok Livelive</h3>
    <p>TikTokLive streams and short making videos.<br>Enjoy real-time interaction!</p>
    <a class="modal-link" href="https://tiktok.com" target="_blank">Å® TikTok View</a>
  `,
};
